(() => {
  const DICTIONARIES = {
    en: {
      ...
      "friends.openButton": "Friends",
      "friends.openAria": "Open friends",
      "friends.close": "Close friends",
      "friends.empty": "You haven't added any friends yet. Share your invite code or add someone by email below.",
      "friends.myInviteCode": "Your invite code",
      "friends.copyCode": "Copy code",
      "friends.codeCopied": "Invite code copied.",
      "friends.codeCopyFailed": "Could not copy invite code.",
      "friends.addHeading": "Add a friend",
      "friends.addByCodeTab": "By invite code",
      "friends.addByEmailTab": "By email",
      "friends.codePlaceholder": "ABC-DEF-GHJ",
      "friends.emailPlaceholder": "friend@example.com",
      "friends.addButton": "Add friend",
      "friends.adding": "Adding...",
      "friends.notFound": "No user found with that {kind}.",
      "friends.kindCode": "invite code",
      "friends.kindEmail": "email",
      "friends.cantFollowSelf": "That's your own {kind} — you can't follow yourself.",
      "friends.added": "Added {name} as a friend.",
      "friends.alreadyFriends": "You're already following {name}.",
      "friends.muted": "Hidden {name}'s recipes.",
      "friends.unmuted": "Showing {name}'s recipes again.",
      "friends.removed": "Removed {name}.",
      "friends.mute": "Hide recipes",
      "friends.unmute": "Show recipes",
      "friends.remove": "Remove",
      "friends.feedTitle": "Friends' recipes",
      "friends.viewFeed": "View friends' recipes",
      "friends.backToMine": "Back to my recipes",
      "friends.feedEmpty": "Your friends haven't shared any recipes yet.",
      "friends.fromBadge": "from {name}",
      "friends.saveToMine": "Save to my recipes",
      "friends.savedToMine": "Saved \"{title}\" to your recipes.",
      "friends.saveFailed": "Could not save recipe: {error}",
      "friends.loadFailed": "Could not load friend recipes: {error}",
      "friends.shareWithFriends": "Share with friends",
      "friends.shareHint": "Friends following you will see this recipe.",
      "friends.featureUnavailable": "Friends feature needs SQL migration. Run sql/friends-migration.sql in Supabase.",
      "friends.profileMissing": "Your profile isn't set up yet. Sign out and back in, or run sql/friends-migration.sql."
    },
    ...
    ru: {
      ...
      "friends.openButton": "Друзья",
      "friends.openAria": "Открыть друзей",
      "friends.close": "Закрыть друзей",
      "friends.empty": "Вы ещё не добавили друзей. Поделитесь кодом или добавьте по email ниже.",
      "friends.myInviteCode": "Ваш код приглашения",
      "friends.copyCode": "Скопировать код",
      "friends.codeCopied": "Код приглашения скопирован.",
      "friends.codeCopyFailed": "Не удалось скопировать код.",
      "friends.addHeading": "Добавить друга",
      "friends.addByCodeTab": "По коду",
      "friends.addByEmailTab": "По email",
      "friends.codePlaceholder": "ABC-DEF-GHJ",
      "friends.emailPlaceholder": "friend@example.com",
      "friends.addButton": "Добавить",
      "friends.adding": "Добавление...",
      "friends.notFound": "Пользователь не найден ({kind}).",
      "friends.kindCode": "код приглашения",
      "friends.kindEmail": "email",
      "friends.cantFollowSelf": "Это ваш собственный {kind} — нельзя добавить себя.",
      "friends.added": "{name} добавлен(а) в друзья.",
      "friends.alreadyFriends": "Вы уже подписаны на {name}.",
      "friends.muted": "Рецепты {name} скрыты.",
      "friends.unmuted": "Рецепты {name} снова видны.",
      "friends.removed": "{name} удалён(а) из друзей.",
      "friends.mute": "Скрыть рецепты",
      "friends.unmute": "Показать рецепты",
      "friends.remove": "Удалить",
      "friends.feedTitle": "Рецепты друзей",
      "friends.viewFeed": "Смотреть рецепты друзей",
      "friends.backToMine": "К моим рецептам",
      "friends.feedEmpty": "Друзья пока не поделились рецептами.",
      "friends.fromBadge": "от {name}",
      "friends.saveToMine": "Сохранить себе",
      "friends.savedToMine": "Рецепт «{title}» сохранён в ваш список.",
      "friends.saveFailed": "Не удалось сохранить рецепт: {error}",
      "friends.loadFailed": "Не удалось загрузить рецепты друзей: {error}",
      "friends.shareWithFriends": "Поделиться с друзьями",
      "friends.shareHint": "Подписанные на вас друзья увидят этот рецепт.",
      "friends.featureUnavailable": "Функция «Друзья» требует SQL-миграции. Выполните sql/friends-migration.sql.",
      "friends.profileMissing": "Профиль не настроен. Выйдите и войдите снова, или выполните sql/friends-migration.sql."
    }
  };
